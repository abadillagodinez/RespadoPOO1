...
public class WsIndicadoresEconomicosLocator extends org.apache.axis.client.Service implements cr.fi.bccr.sdde.ws.WsIndicadoresEconomicos {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cr.fi.bccr.sdde.ws.WsIndicadoresEconomicosSoap.class.isAssignableFrom(serviceEndpointInterface)) {
